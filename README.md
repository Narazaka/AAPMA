...
- 0.2.0-beta.5: ヒエラルキー上で非アクティブのGameObjectについていたAAPMAが動作しなかった問題を修正
- 0.2.0-beta.4: Smooth local/remoteをパススルー動作とする
- 0.2.0-beta.3: Smooth local/remoteが正しく動作しなかった問題を修正
